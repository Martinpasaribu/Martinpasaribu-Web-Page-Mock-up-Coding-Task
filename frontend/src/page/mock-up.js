    ...
    return(
        ...
        <div className=" flex  flex-col md:flex-row  items-end text-center  text-white font-sans h-full">
            ...
            <div className="md:absolute flex flex-col items-center  top-0 left-0 w-full bg-abu text-left h-3/6 md:h-64  md:mt-20">
                ...
                <div className="w-full md:w-1/2 flex flex-col gap-y-2 my-4 md:gap-y-4 md:mt-6 md:mr-20">
                    <div className="flex  gap-x-2 ">
                        ...
                        <div className="w-[18rem] md:w-full ml-2 mt-1">
            ...
            <div className="flex flex-row mx-auto h-screen gap-y-3 w-full md: md:items-end md:justify-end md:w-2/6   bg-opacity-30 bg-yelow2">          
                    ...
                    <div className="flex w-full  pr-4 flex-row gap-y-4 md:flex-col  md:w-3/6 md:mb-6 ">
                        <div className="w-1/6  my-4 ml-6 mr-4  md:w-[8.5rem] md:m-auto">
                            <svg 
                            className="w-5/6 ml-3.5 md:m-auto  fill-white "
                            xmlns="http://www.w3.org/2000/svg" 
                            viewBox="0 0 496 512">
            ...
            <div className="flex justify-around  pr-4 md:flex-col  md:mb-6 gap-y-3 md:gap-y-4 my-2  w-full md:w-full  ">
                ...
                <div className="flex flex-col text-left md:justify-center md:text-center md:items-center  my-auto md:w-full w-[13.2rem] md:mx-auto ">
                    <h1 className="text-xl md:text-sm font-xm font-bold">MICROSOFT EDGE</h1>
                    <h1 className="text-lg md:text-xs ">Version 40+</h1>
                </div>
            ...
            <div className="flex flex-row gap-y-3  w-full h-screen bg-opacity-30 bg-red2 md:w-2/6 md:items-end ">
                ...
                <div className="flex w-full my-2 pr-2 gap-y-3 md:gap-y-4 md:mb-6 md:flex-col md:w-3/6 md:">
                    <div className="w-1/6 ml-7 mr-2 my-4 md:w-[8.5rem] md:m-auto ">                      
                        <svg 
                        className=" w-4/5 ml-2.5  fill-white md:m-auto "
                        xmlns="http://www.w3.org/2000/svg" 
                        viewBox="0 0 512 512">
